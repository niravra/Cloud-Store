...
export SubnetId3=$(aws ec2 describe-subnets | grep SubnetId | awk '{print$2}' | tr -d '",'| tr '\n' ' ' | cut -d ' ' -f 3)
export SubnetId4=$(aws ec2 describe-subnets | grep SubnetId | awk '{print$2}' | tr -d '",'| tr '\n' ' ' | cut -d ' ' -f 4)
